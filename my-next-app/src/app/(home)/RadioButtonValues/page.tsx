...
export default function TaskListPage() {
    ...
    async function loadPermissions() {
        const res = await fetch(
            "/api/permissions?controller=RadioButtonValues&action=Index"
        );
    ...
    async function loadData() {
        const res = await fetch("/api/radiobuttonvalues");
    ...
    async function handleDelete(id: number) {
        ...
        await fetch(`/api/radiobuttonvalues?id=${id}`, {
            method: "DELETE",
        });
    ...
    async function handleEdit(item: any) {
        const res = await fetch(`/api/radiobuttonvalues?id=${item.Id}`);
        const json = await res.json();
    ...
    async function handleSave() {
        await fetch("/api/radiobuttonvalues", {
            method: "POST",
            body: JSON.stringify({
                Id: id,
                Name: name,
                    ...
                    <div className="modal-box">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="input-box"
                                placeholder="Radio Button Value"
                            />
                        </div>
