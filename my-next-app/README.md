...
- Initial Release - [May 13, 2024]
 ...
 node_modules is added to .gitignore, so Git ignores it.

 When you push your project:

✅ These files are usually pushed:

package.json
package-lock.json (or yarn.lock)


Do npm i to install node.
...
git pull "branch-name" to take the pull form the exisisting branch to current branch.